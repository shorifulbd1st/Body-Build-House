...
const Trainer = ({ trainer }) => {
    ...
    return (
        <div>
            {/* <div className="w-full h-[40rem]  overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800">
                <div className='w-full h-96 border-2 border-red-500'>
                    <img
                        className="w-full h-full  rounded-lg object-none object-[40%_8%] scale-80"
                        src={photoURL}
                        alt="avatar"
                    />
                </div>
                ...
                <div className="flex items-center px-6 py-3 bg-gray-900">
                    <h1 className="mx-3 text-lg font-semibold text-white flex justify-start items-center -ml-3"><span className='text-3xl'><MdSportsGymnastics /></span> {name}</h1>
                </div>
            ...
            <div class="w-full overflow-hidden bg-white rounded-lg shadow-xl dark:bg-gray-800 border-b-4 border-blue-500" >
                ...
                <div className='my-4 text-center flex justify-center items-end'>
                    <Link to={`/trainerDetails/${_id}`}
                        className=" p-2 text-md font-semibold text-white uppercase transition-colors duration-300 transform bg-gray-800 rounded  dark:hover:bg-gray-600 focus:bg-gray-700 dark:focus:bg-gray-600 focus:outline-none"
                    >
                        know more
                    </Link>
                </div>
