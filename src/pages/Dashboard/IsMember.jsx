            ...
            <div>
                <aside className="bg-[#0A273D] flex flex-col h-full px-4 py-8 overflow-y-auto  border-r-2  dark:bg-gray-900 dark:border-gray-700">
                    ...
                    <h1 className="text-center flex">
                        <span className="text-2xl font-semibold text-center text-transparent bg-clip-text text-white drop-shadow-lg">
                            Body Build House
                        </span>
                    </h1>
                    ...
                    <div className="flex flex-col justify-between flex-1 mt-6">
                        <nav>
                            ...
                            <NavLink
                                ...
                                className={({ isActive }) =>
                                    `flex items-center px-4 py-2 mt-5  transition-colors duration-300 transform rounded-lg hover:bg-white hover:text-black ${isActive ? "text-white bg-green-500" : "text-white"
                                    }`
                                }
                            >
                                <svg
                                ...
                                <span className="mx-4 font-medium">Activity Log</span>
                            </NavLink>
                            ...
                            >
                                ...
                                <span className="mx-4 font-medium">Be a Trainer</span>
                            </NavLink>
                            ...
                            >
                                ...
                                <span className="mx-4 font-medium">Booked Trainer</span>
                            </NavLink>
