        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-4">
              <button
                type="submit"
                className="w-full px-6 py-2 text-md font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-green-800 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50"
              >
                Register
              </button>
            </div>
