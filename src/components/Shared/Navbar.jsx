      ...
      <nav className="relative text-white shadow dark:bg-gray-800 bg-[#0A273D]">
        <div className="w-11/12 py-4 mx-auto">
          <div className="lg:flex justify-between">
            ...
            <div className="flex items-center justify-between">
              <div className="relative flex justify-center items-center">
                ...
                <h1 className="text-center flex">
                  <a
                    href="/"
                    className="text-2xl cursor-pointer font-semibold text-center text-transparent bg-clip-text  drop-shadow-lg text-white"
                  >
                    Body Build House
                  </a>
                </h1>
            ...
            <div
              className={`absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-700 ease-in-out bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:flex lg:items-center ${
                isOpen
            ...
            >
              <div className="flex flex-col -mx-6 lg:flex-row lg:items-center lg:mx-2 xl:mx-4 xl:text-lg">
                <NavLink
                  to="/"
                  className={({ isActive }) =>
                    `inline-block px-2 py-2 mx-3 mt-2  transition-colors duration-700 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-green-500 text-white dark:hover:bg-gray-700 ${
                      isActive ? "bg-[#C70039]" : ""
                    }`
                  }
                >
                ...
                <NavLink
                  to="/all-trainer"
                  className={({ isActive }) =>
                    `inline-block px-2 py-2 text-white mx-3 mt-2 transition-colors duration-700 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-green-500 dark:hover:bg-gray-700 ${
                      isActive ? "bg-[#C70039] text-white" : ""
                    }`
                  }
                >
                  All Trainer
                ...
                <NavLink
                  to="/all-classes"
                  className={({ isActive }) =>
                    `inline-block px-2 py-2 mx-3 mt-2 transition-colors duration-700 transform rounded-md text-white lg:mt-0 dark:text-gray-200 hover:bg-green-500 dark:hover:bg-gray-700 ${
                      isActive ? "bg-[#C70039]" : ""
                    }`
                  }
                >
                ...
                {user?.email && (
                  <>
                    <NavLink
                      to="/profile"
                      className={({ isActive }) =>
                        `inline-block px-2 py-2 mx-3 mt-2 text-white transition-colors duration-700 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-green-500 dark:hover:bg-gray-700 ${
                          isActive ? "bg-[#C70039]" : ""
                        }`
                      }
                    >
