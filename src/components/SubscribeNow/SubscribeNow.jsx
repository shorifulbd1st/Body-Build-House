            ...
            <div className="w-full lg:w-1/2">
              ...
              >
                <h1 className="text-3xl font-semibold text-gray-800 dark:text-white lg:text-4xl">
                  Subscribe To The{" "}
                  <span className="text-[#C70039]">Newsletter</span>
                </h1>
                <p className="mt-3 text-gray-600 dark:text-gray-400">
                  Stay updated with fitness tips, workout plans, and nutrition
                  advice. Subscribe now and achieve your fitness goals faster!
                </p>
