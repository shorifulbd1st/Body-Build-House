...
const IsTrainer = () => {
  ...
  return (
    <div>
      <div>
        <aside className=" flex flex-col h-full px-4 py-8 overflow-y-auto  dark:bg-gray-900 dark:border-gray-700">
            ...
            <nav className="max-h-screen flex flex-col justify-between flex-1 mt-6">
              <div>
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center px-4 py-2 text-gray-700 transition-colors duration-300 transform rounded-lg hover:bg-white hover:text-black ${
                      isActive ? "text-white bg-green-500" : "text-white"
                    }`
                  }
                >
                  <svg
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    `flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-300 transform rounded-lg hover:bg-white hover:text-black ${
                      isActive ? "text-white bg-green-500" : "text-white"
                    }`
                  }
                >
                  ...
                  <span className="mx-4 font-medium"> Add New Slots</span>
                </NavLink>
